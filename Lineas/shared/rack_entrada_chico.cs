...
namespace Lineas.shared {
    public partial class rack_entrada_chico : UserControl, shared.Irack_entrada {
        public shared.workrack workrack;

        public rack_entrada_chico() {
            InitializeComponent();
        }
        private void rack_entrada_chico_Load( object sender, EventArgs e ) {
